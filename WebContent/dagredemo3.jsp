...
<script>
   ...
   */
   //{"Repair (Complex)(com":{"inputQueue":["Inform User(complete"],"inputThroughput":[73],"count":54,"consumers":2},"Register(start)":{"count":102,"consumers":1},"Repair (Complex)(sta":{"inputQueue":["Analyze Defect(compl"],"inputThroughput":[58],"count":54,"consumers":2},"Analyze Defect(compl":{"inputQueue":["Analyze Defect(start"],"inputThroughput":[111],"count":102,"consumers":2},"Test Repair(start)":{"inputQueue":["Repair (Simple)(comp"],"inputThroughput":[101],"count":156,"consumers":2},"Inform User(complete":{"inputQueue":["Inform User(start)"],"inputThroughput":[101],"count":102,"consumers":2},"Restart Repair(start":{"inputQueue":["Test Repair(complete"],"inputThroughput":[61],"count":54,"consumers":2},"Repair (Simple)(star":{"inputQueue":["Analyze Defect(compl"],"inputThroughput":[80],"count":102,"consumers":2},"Test Repair(complete":{"inputQueue":["Test Repair(start)"],"inputThroughput":[165],"count":156,"consumers":2},"Restart Repair(compl":{"inputQueue":["Restart Repair(start"],"inputThroughput":[53],"count":54,"consumers":2},"Repair (Simple)(comp":{"inputQueue":["Repair (Simple)(star"],"inputThroughput":[60],"count":102,"consumers":2},"Archive Repair(compl":{"inputQueue":["Archive Repair(start"],"inputThroughput":[101],"count":102,"consumers":2},"Inform User(start)":{"inputQueue":["Repair (Simple)(star"],"inputThroughput":[55],"count":102,"consumers":2},"Analyze Defect(start":{"inputQueue":["Register(complete)"],"inputThroughput":[101],"count":102,"consumers":2},"Archive Repair(start":{"inputQueue":["Test Repair(complete"],"inputThroughput":[111],"count":102,"consumers":2}};
 
   {"Repair (Complex)(com":{"inputQueue":["Register(start)"],"inputThroughput":[73],"count":54,"consumers":2},"Register(start)":{"count":102,"consumers":1}};
   /* 
   {
