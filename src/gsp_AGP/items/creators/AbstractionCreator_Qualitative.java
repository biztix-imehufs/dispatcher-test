 ...
 */
package gsp_AGP.items.creators;
...
import gsp_AGP.items.CandidateInSequenceFinder;
import gsp_AGP.items.Item;
import gsp_AGP.items.Itemset;
import gsp_AGP.items.Sequence;
import gsp_AGP.items.abstractions.Abstraction_Generic;
import gsp_AGP.items.abstractions.Abstraction_Qualitative;
import gsp_AGP.items.abstractions.ItemAbstractionPair;
import gsp_AGP.items.patterns.Pattern;
import gsp_AGP.items.patterns.PatternCreator;
